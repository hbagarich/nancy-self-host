...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(2);
var hubConnection = __webpack_require__(28).hubConnection;
...
var Hello = /** @class */ (function (_super) {
    ...
    function Hello(props) {
        ...
        var newConnection = hubConnection(endpoint, { logging: true });
        var newHub = newConnection.createHubProxy('HelloWorldHub');
        newHub.on('broadcastMessage', function (myMessage) {
            console.log('SignalR');
    ...
    Hello.prototype.onWebApiClick = function () {
    ...
    Hello.prototype.render = function () {
        return React.createElement("h1", { onClick: this.onWebApiClick },
            "Hello from ",
            this.props.compiler,
            " and ",
...
var jQueryShim = __webpack_require__(29);
...
var jQueryDeferred = __webpack_require__(30);
...
var jQuery = module.exports = __webpack_require__(32),
...
var jQuery = module.exports = __webpack_require__(33),
	core_rspace = /\s+/;
/**
* jQuery Callbacks
*
